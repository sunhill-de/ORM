<?php
/**
 * @file CollectionUpdater.php
 * Defines the class CollectionUpdater. This class is used to update an object/collection to a 
 * storage 
 * @author Klaus Dimde
 * ---------------------------------------------------------------------------------------------------------
 * Lang en
...
class CollectionUpdater extends StorageInteractionBase
{
