...
class ComplexCollectionsFieldOArrayTableSeeder extends Seeder {
	
    public function run() {
        DB::table('complexcollections_field_oarray')->truncate();
        DB::table('complexcollections_field_oarray')->insert([
