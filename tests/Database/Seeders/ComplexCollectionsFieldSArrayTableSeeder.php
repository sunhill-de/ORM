...
class ComplexCollectionsFieldSArrayTableSeeder extends Seeder {
	
    public function run() {
        DB::table('complexcollections_field_sarray')->truncate();
        DB::table('complexcollections_field_sarray')->insert([
