...
class ObjectUpdateTest extends DatabaseTestCase
{
    ...
    public function testUpdateDummy()
    {
        $test = new Dummy();
        $test->load(1);
        $test->dummyint = 919;
    ...
    public function testUpdateTestParent()
    {
        $test = new TestParent();
        $test->load(9);
        $test->parentint = 842;
        ...
        $test->parentsarray[1] = 'Def Leppard';
    ...
    public function testUpdateTestChild()
    {
        $test = new TestChild();
        $test->load(17);
        ...
        $test->parentobject = $this->getDummy(1);
        $test->parentcollection = $this->getCollection(1);
        $test->parentoarray[0] = $this->getDummy(2);
        $test->parentoarray[] = $this->getDummy(3);
        $test->parentsarray->clear();
        $test->parentsarray[] = 'Iron Maiden';
        ...
        $test->childoarray[0] = $this->getDummy(5);
        $test->childoarray[] = $this->getDummy(6);
        $test->childsarray->clear();
    ...
    public function testLoadReferenceOnly()
    {
        ...
        $load = Objects::load($test->getID());
        $this->assertEquals('Bruce Springsteen', $load->testsarray[3]);
        $this->assertEquals(234, $load->testoarray[2]->dummyint);
    }
